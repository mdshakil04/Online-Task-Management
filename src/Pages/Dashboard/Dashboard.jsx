...
const Dashboard = () => {
  ...
  return (
    <div className=" ">
      ...
      <div className=" justify-center flex gap-12 mt-8">
        <button className=" btn btn-outline btn-accent lg:text-2xl">New Task</button>
        <button className=" btn btn-outline btn-accent lg:text-2xl">See Previous Task</button>
      </div>
      <div>
        <div className="hero ">
            ...
            <div className="card shrink-0 w-1/2 ">
              <form className="card-body">
                ...
                <div className="form-control mt-6">
                  <button className="btn btn-accent text-white text-2xl">Add task</button>
                </div>
              </form>
            </div>
          </div>
